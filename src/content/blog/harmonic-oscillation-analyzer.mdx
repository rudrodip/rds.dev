...
date: "2023-09-04"
image: /assets/images/blog/harmonic-oscillator/blog-bg.png
authors:
  - rds
---
...
Its highly recommended for you to read this section, otherwise it will not be easy to setup the project and to understand the UI.
...
<Image
  src="/assets/images/blog/harmonic-oscillator/buttons.png"
  width="718"
  height="404"
...
<Image
  src="/assets/images/blog/harmonic-oscillator/hsv.png"
  width="718"
  height="404"
...
<Image
  src="/assets/images/blog/harmonic-oscillator/analyze.png"
  width="718"
  height="404"
  alt="Analyze Widget"
/>
...
<Image
  src="/assets/images/blog/harmonic-oscillator/full.png"
  width="718"
  height="404"
  alt="Graph"
/>
...
## Detecting Circular Motion with <ins>least_square</ins>
...
**How?** I implemented the `rotated_circle_residuals` function, powered by `least_square`. This function calculates the differences between the observed data points and the expected points on a rotated circle.
...
- $$ x_{\text{rotated}} $$ and $$ y_{\text{rotated}} $$ represent the rotated coordinates.
- $$ x $$ and $$ y $$ are the original coordinates.
- $$ a $$ and $$ b $$ are the coordinates of the circle's center.
- $$ theta $$ is the angle of rotation (in radians).

These equations describe how the rotation of coordinates is applied to the data points based on the specified center ('a', 'b') and rotation angle ('theta') in the `rotated_circle_residuals` function.
...
## Fitting the Harmonic Puzzle with <ins>curve_fit</ins>
...
In the world of physics, we often describe how things move using equations. For our system, we use something called a second-order ordinary differential equation (ODE). Don't worry, it's not as scary as it sounds!
...
- $$ x(t) $$ is how far our mass has moved from its resting position at a certain time $$t$$.
- The squiggly $$d$$ things represent derivatives, which are just fancy ways of talking about how things change. $$\frac{dx(t)}{dt}$$ is the velocity, and $$\frac{d^2x(t)}{dt^2}$$ is the acceleration.
- $$m$$ is the mass of our object.
- $$\gamma$$ is how much the damper slows things down.
...
- $$\gamma$$ is still the damping thing, but don't worry, it's not as scary anymore.
- $$\omega$$ is the angular frequency, and it's related to how fast our system naturally likes to swing. It depends on things like the length of a pendulum's string.
- $$\phi$$ is the phase angle, which is all about the timing of our oscillation.
...
- $$\gamma$$ is still that damping thing.
...
The formula for the angular frequency ($$\omega_0$$) of a compound pendulum is given as follows:
...
Where:
- $$\omega$$ is the angular frequency of the compound pendulum.
